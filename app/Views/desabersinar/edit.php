...
<main id="main" class="main">
    <div class="pagetitle">
    <h1>Edit Desa Bersinar</h1>
    <nav>
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url();?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo site_url('desa-bersinar');?>">Data Desa Bersinar</a></li>
        <li class="breadcrumb-item active">Edit Data Desa Bersinar</li>
        </ol>
    </nav>
    </div><!-- End Page Title -->
    <section class="section dashboard">

    <?php echo form_open('desa-bersinar/update/'.$id); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" 
                   ...
                   value="<?php echo $query->id_desa_bersinar; ?>" 
                   required>
        </div>
