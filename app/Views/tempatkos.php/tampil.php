...
<main id="main" class="main">
    ...
    <div class="mb-3 mt-3">
        <?php echo anchor(
            'tempatkos/tambah',
            '<i class="fa-solid fa-plus"></i> Tambah tempat_kos',
        ...
        <tbody >
            ...
            if (!empty($query)) {
                foreach ($query as $baris) { ?>
                    <tr>
                    <td><?php echo $baris['namakos']; ?></td>
                        <td><?php echo $baris['alamat']; ?></td>
                        <td><?php echo $baris['id_kelurahan']; ?></td>
                        <td><?php echo $baris['jumlahkamar']; ?></td>
                        <td><?php echo $baris['keterangan']; ?></td>
                    <td>
                       <!-- Tombol Edit -->
                       <a href="<?= site_url('tempatkos/edit/' . $baris['namakos']); ?>" 
                          class="btn btn-success btn-sm">
                          <i class="fa-solid fa-edit"></i> Edit
                         </a>
                          <!-- Tombol Hapus -->
                          <a href="<?= site_url('tempatkos/hapus/' . $baris['namakos']); ?>" 
